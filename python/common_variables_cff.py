...
L3Variables = cms.PSet(
    l3pt = cms.string("? triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() ? 0 : triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).pt"),
    l3dr = cms.string("? triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() ? 999 : "+
                      " deltaR( eta, phi, " +
                      "         triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).eta, "+
...
HighPtTriggerFlags = cms.PSet(
   ...
   # 2015 version
   DoubleIsoMu17Mu8dZ_Mu17leg = cms.string("!triggerObjectMatchesByPath('HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v*',1,0).empty() && !triggerObjectMatchesByFilter('hltL3fL1DoubleMu155fFiltered17').empty()"),
   DoubleIsoMu17Mu8_IsoMu17leg = cms.string("!triggerObjectMatchesByFilter('hltDiMuon178RelTrkIsoFiltered0p4').empty() && !triggerObjectMatchesByFilter('hltL3fL1DoubleMu155fFiltered17').empty()"),
   DoubleIsoMu17Mu8_Mu17leg = cms.string("!triggerObjectMatchesByFilter('hltL3fL1DoubleMu155fFiltered17').empty()"),
   DoubleIsoMu17Mu8_IsoMu8leg = cms.string("!triggerObjectMatchesByFilter('hltDiMuon178RelTrkIsoFiltered0p4').empty() && (!triggerObjectMatchesByFilter('hltL3fL1DoubleMu155fPreFiltered8').empty())"),
   DoubleIsoMu17Mu8_Mu8leg = cms.string("(!triggerObjectMatchesByFilter('hltL3fL1DoubleMu155fPreFiltered8').empty())"),
   ...
   DoubleIsoMu17Mu8dZMass3p8_Mu17leg = cms.string("!triggerObjectMatchesByPath('HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v*',1,0).empty() && !triggerObjectMatchesByFilter('hltL3fL1DoubleMu155fFiltered17').empty()"),
   DoubleIsoMu17Mu8dZMass8_Mu17leg = cms.string("!triggerObjectMatchesByPath('HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v*',1,0).empty() && !triggerObjectMatchesByFilter('hltL3fL1DoubleMu155fFiltered17').empty()"),
...
HighPtTriggerFlagsDebug = cms.PSet(
   ...
   hltL2fL1sMu18L1f0L2Filtered10Q = cms.string("!triggerObjectMatchesByFilter('hltL2fL1sMu18L1f0L2Filtered10Q').empty()"),
   hltL3fL1sMu18L1f0L2f10QL3Filtered20Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu18L1f0L2f10QL3Filtered20Q').empty()"),
   hltL3fL1sMu18L1f0L2f10QL3Filtered20QL3pfecalIsoRhoFilteredEB0p14EE0p10 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu18L1f0L2f10QL3Filtered20QL3pfecalIsoRhoFilteredEB0p14EE0p10').empty()"),
   hltL3fL1sMu18L1f0L2f10QL3Filtered20QL3pfhcalIsoRhoFilteredHB0p16HE0p20 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu18L1f0L2f10QL3Filtered20QL3pfhcalIsoRhoFilteredHB0p16HE0p20').empty()"),
   hltL3crIsoL1sMu18L1f0L2f10QL3f20QL3trkIsoFiltered0p07 = cms.string("!triggerObjectMatchesByFilter('hltL3crIsoL1sMu18L1f0L2f10QL3f20QL3trkIsoFiltered0p07').empty()"),
   hltL3fL1sMu18f0TkFiltered20Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu18f0TkFiltered20Q').empty()"),
   hltL3fL1sMu18f0TkFiltered20QL3pfecalIsoRhoFilteredEB0p14EE0p10 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu18f0TkFiltered20QL3pfecalIsoRhoFilteredEB0p14EE0p10').empty()"),
   hltL3fL1sMu18f0TkFiltered20QL3pfhcalIsoRhoFilteredHB0p16HE0p20 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu18f0TkFiltered20QL3pfhcalIsoRhoFilteredHB0p16HE0p20').empty()"),
   hltL3fL1sMu18L1f0Tkf20QL3trkIsoFiltered0p07 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu18L1f0Tkf20QL3trkIsoFiltered0p07').empty()"),


   #add the filter for muon 24 path familly
   hltL2fL1sSingleMu22L1f0L2Filtered10Q = cms.string("!triggerObjectMatchesByFilter('hltL2fL1sSingleMu22L1f0L2Filtered10Q').empty()"),
   hltL3fL1sSingleMu22L1f0L2f10QL3Filtered24Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sSingleMu22L1f0L2f10QL3Filtered24Q').empty()"),
   hltL3crIsoL1sSingleMu22L1f0L2f10QL3f24QL3pfecalIsoRhoFilteredEB0p14EE0p10 = cms.string("!triggerObjectMatchesByFilter('hltL3crIsoL1sSingleMu22L1f0L2f10QL3f24QL3pfecalIsoRhoFilteredEB0p14EE0p10').empty()"),
   hltL3crIsoL1sSingleMu22L1f0L2f10QL3f24QL3pfhcalIsoRhoFilteredHB0p16HE0p20 = cms.string("!triggerObjectMatchesByFilter('hltL3crIsoL1sSingleMu22L1f0L2f10QL3f24QL3pfhcalIsoRhoFilteredHB0p16HE0p20').empty()"),
   hltL3crIsoL1sSingleMu22L1f0L2f10QL3f24QL3trkIsoFiltered0p07 = cms.string("!triggerObjectMatchesByFilter('hltL3crIsoL1sSingleMu22L1f0L2f10QL3f24QL3trkIsoFiltered0p07').empty()"),
   hltL3fL1sMu22f0TkFiltered24Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22f0TkFiltered24Q').empty()"),
   hltL3fL1sMu22f0TkFiltered24QL3pfecalIsoRhoFilteredEB0p14EE0p10 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22f0TkFiltered24QL3pfecalIsoRhoFilteredEB0p14EE0p10').empty()"),
   hltL3fL1sMu22f0TkFiltered24QL3pfhcalIsoRhoFilteredHB0p16HE0p20 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22f0TkFiltered24QL3pfhcalIsoRhoFilteredHB0p16HE0p20').empty()"),
   hltL3fL1sMu22L1f0Tkf24QL3trkIsoFiltered0p07 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22L1f0Tkf24QL3trkIsoFiltered0p07').empty()"),

 #add the filter for muon 27 path familly
 hltL2fL1sMu22or25L1f0L2Filtered10Q = cms.string("!triggerObjectMatchesByFilter('hltL2fL1sMu22or25L1f0L2Filtered10Q').empty()"),
 hltL3fL1sMu22Or25L1f0L2f10QL3Filtered27Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22Or25L1f0L2f10QL3Filtered27Q').empty()"),
 hltL3fL1sMu22Or25L1f0L2f10QL3Filtered27QL3pfecalIsoRhoFilteredEB0p14EE0p10 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22Or25L1f0L2f10QL3Filtered27QL3pfecalIsoRhoFilteredEB0p14EE0p10').empty()"),
 hltL3fL1sMu22Or25L1f0L2f10QL3Filtered27QL3pfhcalIsoRhoFilteredHB0p16HE0p20 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22Or25L1f0L2f10QL3Filtered27QL3pfhcalIsoRhoFilteredHB0p16HE0p20').empty()"),
 hltL3crIsoL1sMu22Or25L1f0L2f10QL3f27QL3trkIsoFiltered0p07 = cms.string("!triggerObjectMatchesByFilter('hltL3crIsoL1sMu22Or25L1f0L2f10QL3f27QL3trkIsoFiltered0p07').empty()"),
 hltL3fL1sMu22Or25f0TkFiltered27Q = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22Or25f0TkFiltered27Q').empty()"),
 hltL3fL1sMu22Or25f0TkFiltered27QL3pfecalIsoRhoFilteredEB0p14EE0p10 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22Or25f0TkFiltered27QL3pfecalIsoRhoFilteredEB0p14EE0p10').empty()"),
 hltL3fL1sMu22Or25f0TkFiltered27QL3pfhcalIsoRhoFilteredHB0p16HE0p20 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22Or25f0TkFiltered27QL3pfhcalIsoRhoFilteredHB0p16HE0p20').empty()"),
 hltL3fL1sMu22Or25L1f0Tkf27QL3trkIsoFiltered0p07 = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sMu22Or25L1f0Tkf27QL3trkIsoFiltered0p07').empty()"),
...
LowPtTriggerFlagsPhysics = cms.PSet(
    ...
    ## L3 Mu
    Mu_L3 = cms.string(                 "!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty()"
                                        ),
    ## Vertexing filters
    Dimuon6_Jpsi_NoVertexing = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                          " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltDimuon6JpsiL3Filtered')"),
    Dimuon0er16_Jpsi_NoVertexing = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                              " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltDimuon0JpsiOSL3Filtered')"),
    Dimuon0er16_Jpsi_NoOS_NoVertexing = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                                   " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltDimuon0JpsiNoOSL3Filtered')"),
    ## Final filters
    Dimuon16_Jpsi = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                               " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltDisplacedmumuFilterDimuon16Jpsi')"),
    Dimuon20_Jpsi = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                               " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltDisplacedmumuFilterDimuon20Jpsi')"),
    Dimuon10_Jpsi_Barrel = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                      " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltDisplacedmumuFilterDimuon10JpsiBarrel')"),
)

LowPtTriggerFlagsEfficienciesTag = cms.PSet(
   ## Mu + Track
   ## 2012
   Mu5_Track2_Jpsi_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                   " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu5Track2JpsiTrackMassFiltered')"),
   Mu5_Track3p5_Jpsi_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                   " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu5Track3p5JpsiTrackMassFiltered')"),
   Mu7_Track7_Jpsi_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                   " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu7Track7JpsiTrackMassFiltered')"),

   ## 2015
   Mu7p5_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && " +
                         " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltL3fLMu7p5TrackL3Filtered7p5')"
                         ),

   Mu7p5_Track2_Jpsi_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                     " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu7p5Track2JpsiTrackMassFiltered')"),
   Mu7p5_Track3p5_Jpsi_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                       " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu7p5Track3p5JpsiTrackMassFiltered')"),
   Mu7p5_Track7_Jpsi_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                     " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu7p5Track7JpsiTrackMassFiltered')"),

   ## Mu + L2Mu
   ## 2012
   Mu5_L2Mu0_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                             " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu5L2Mu0L3Filtered5')"),
   Mu5_L2Mu2_Jpsi_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                  " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu5L2Mu2JpsiTrackMassFiltered')"),
   Mu5_L2Mu3_Jpsi_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                  " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu5L2Mu3JpsiTrackMassFiltered')"),
   ## 2015
   Mu7p5_L2Mu2_Jpsi_MU = cms.string("!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                 " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltMu7p5L2Mu2JpsiTrackMassFiltered')"),

   ## Mu + TkMu
   ## 2015
   Mu25TkMu0Onia_L3_MU = cms.string(   "!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && " +
                                       " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltL3fL1sMu16orMu20erorMu25L1f0L2f0L3Filtered25')"
                                       ),
...
LowPtTriggerFlagsEfficienciesProbe = cms.PSet(
   ...
   Mu25TkMu0Onia_L3 = cms.string(      "!triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty() && "+
                                       " triggerObjectMatchesByCollection('hltIterL3MuonCandidates').at(0).hasFilterLabel('hltL3fL1sMu16orMu20erorMu25L1f0L2f0L3Filtered25')"
                                       ),
