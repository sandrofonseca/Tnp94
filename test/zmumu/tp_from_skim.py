...
if "CMSSW_7_4_" in os.environ['CMSSW_VERSION']:
    ...
    process.source.fileNames = [
        'file:/afs/cern.ch/work/s/sesanche/private/Muons/CMSSW_10_1_4/src/BE2532CB-EF5D-E811-B061-FA163EB55721.root',
        'file:/afs/cern.ch/work/s/sesanche/private/Muons/CMSSW_10_1_4/src/CAE38C94-065E-E811-9882-FA163EB4D5EF.root',
        'file:/afs/cern.ch/work/s/sesanche/private/Muons/CMSSW_10_1_4/src/D4F3D7E1-1C5E-E811-8300-FA163EF275F7.root'
        ]            
...
process.load("MuonAnalysis.TagAndProbe.common_modules_skim_cff")
